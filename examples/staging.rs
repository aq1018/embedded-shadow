...
pub fn main() {
    ...
    host.with_view(|view| {
        ...
        view.write_range_staged(0x00, &[0x11, 0x22, 0x33, 0x44]).unwrap();
        view.write_range_staged(0x10, &[0x55, 0x66, 0x77, 0x88]).unwrap();
    ...
    host.with_view(|view| {
        ...
        view.write_range_staged(0x180, &[0x01, 0x02, 0x03, 0x04]).unwrap();
